      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="bayar.php"><i class="fas fa-database"></i> <span>DATA BAYAR PKL</span></a></li>
              <li><a class="nav-link" href="sekolah.php"><i class="fas fa-database"></i> <span>DATA SEKOLAH</span></a></li>
