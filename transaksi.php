        ...
        <section class="section">
         ...
         <div class="row">
            ...
            <span class="input-group-text" id="basic-addon1">Tanggal Bayar</span>
              ...
              <div class="input-group mb-3">
             <div class="input-group-prepend">
            <span class="input-group-text" id="basic-addon1">ID BAYAR</span>
               </div>
                <input type="text" name="id_bayar" class="form-control" placeholder="id_bayar" aria-label="masukkan id" aria-describedby="basic-addon1">
                </div>
            ...
            <br/>   
              ...
              <table class="table table-striped table-responsive">
               ...
               <th scope="col"> NISN</th>
                ...
                <tbody>
                  <?php 
                  $query = mysqli_query($koneksi,"SELECT * FROM transaksi WHERE nisn='$data[nisn]' ORDER BY bulan_dibayar ASC");
