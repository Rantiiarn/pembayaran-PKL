        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item text-primary">Edit Petugas</div>
            </div>
          </div>
          <div class="row">
              <div class="col-12">
                      ...
                      <div class="wizard-pane">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4 col-md-6 text-right">
                            <button type="submit" class="btn btn-icon icon-right btn-primary">UBAH PETUGAS<i class="fas fa-arrow-right"></i></button>>
                          </div>
                        </div>
                      </div>
                    </form>
