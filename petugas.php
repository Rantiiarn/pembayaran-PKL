        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item text-primary">Data petugas</div>
            </div>
          </div>
            <div class="row">
              <div class="col-12">
                      ...
                      <table class="table table-striped">
                       <thead>
                        ...
                        <tr>  
                          ...
                          <a href="hapus_petugas.php?id=<?php echo $row['id_petugas']; ?>" class="btn btn-danger" onClick="return confirm('Anda yakin akan menghapus data ini?')"><i class="fas fa-trash"></i></a>
                          </td>
                        </tr>
                         <?php
                           $no++;
