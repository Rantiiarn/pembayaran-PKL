...
<title>Kwitansi Pembayaran PKL SMKN 4 TASIKMALAYA</title>
</head>
...
<p>&nbsp;</p>
  ...
  <table>
    ...
    <tbody>
      <?php
    $query = "SELECT * FROM transaksi,siswa,bayar,petugas,sekolah WHERE transaksi.nisn=siswa.nisn AND siswa.id_bayar=bayar.id_bayar AND transaksi.id_petugas=petugas.id_petugas AND siswa.id_sekolah=sekolah.id_sekolah AND (transaksi.tgl_bayar between '$daritanggal' AND '$sampaitanggal')";
  ...
  ?>
       ...
       <tr>
		  ...
		  <td><?= $sekolahnow; ?> - <?= $data['nama_sekolah']; ?></td>
